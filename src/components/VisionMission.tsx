    ...
    <section id="vision" className="py-20 relative overflow-hidden">
      ...
      <div className="relative container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 max-w-6xl mx-auto">
          ...
          {/* Mission Card */}
          <div className="bg-green-500/90 backdrop-blur-xl p-10 rounded-2xl border border-white/20 shadow-2xl animate-slide-in-right hover:scale-[1.03] transition-all duration-300">
            <div className="flex items-center gap-4 mb-6">
              <div className="w-14 h-14 bg-green-700 rounded-xl flex items-center justify-center shadow-md">
